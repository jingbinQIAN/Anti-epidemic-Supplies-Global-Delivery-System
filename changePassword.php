...
$sid = $_GET["new"];	
echo "<h3 class = 'hint'>
<input type='hidden' value='$sid' name='account' id='account'/><br>
<label>New Password:</label>
<input type='password' name='spsd' id='spsd' style='font-size: 20px; border-radius: 19px' /><br><br>
<input type='submit' style='font-size: 30px; border-radius: 19px; color:mediumseagreen' name='login' value='Update' />
</h3>";
