...
<body>
    ...
    <h3 id="lognavigation">Navigation &nbsp &nbsp &nbsp &nbsp 
...
<div class = "Tip">
<h1 class= "logfunction" style="text-align: center">Student Register</h1>
<h3 class = "hint">
<?php 
	...
	$account = "t2000".$accountnum;
	$sql = "INSERT INTO Student (account, stu_name, ID, password, country) VALUES ('$account', '$sname', '$id', '$psd', '$country')";
